 ...
 * exactement ce que l'agent a composé en suivant templates/Charte_PDF_SEO_GEO_V3.md.
...
const agencyName = String(theme.identity?.agency_name || "SEO/GEO Squad").trim();
...
(async () => {
  ...
  const bundledAssetRoots = [
    ...
    path.resolve(__dirname, "../skill/seo-geo-v3/assets"),
