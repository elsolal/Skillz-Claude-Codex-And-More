...
- Livrable composé en HTML par l'Agent 11 selon `templates/Charte_PDF_SEO_GEO_V3.md`, puis imprimé par `tools/render_html_pdf.cjs`. Un Markdown produit par un outil de contrôle interne n'est jamais une sortie client déclarable.
