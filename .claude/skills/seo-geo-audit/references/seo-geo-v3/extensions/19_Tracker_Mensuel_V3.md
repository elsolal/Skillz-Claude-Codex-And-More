...
- `skill/seo-geo-v3/references/workflows/11_monitoring_delta.md` ;
- `skill/seo-geo-v3/scripts/advanced/control_center.py` ;
- `skill/seo-geo-v3/scripts/advanced/delta_compare.py` ;
- `skill/seo-geo-v3/scripts/advanced/import_metrics.py` ;
- `skill/seo-geo-v3/scripts/advanced/narrative_integrity.py`.
