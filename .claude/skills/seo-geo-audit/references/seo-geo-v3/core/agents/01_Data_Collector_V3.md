...
- `skill/seo-geo-v3/references/architecture.md` ;
- `skill/seo-geo-v3/references/data_model.md` ;
- `skill/seo-geo-v3/references/workflows/02_collecte_preuves.md` ;
- `skill/seo-geo-v3/references/product/security_governance.md` ;
- `skill/seo-geo-v3/assets/kit/schemas/evidence.schema.json` ;
- `skill/seo-geo-v3/assets/kit/schemas/events.schema.json` ;
- `skill/seo-geo-v3/scripts/collect_site.py` lorsque son usage correspond au manifeste. L'URL cible est un argument positionnel et le projet se passe via `--project` : depuis `skill/seo-geo-v3/`, `python3 scripts/collect_site.py https://www.exemple.fr --project /chemin/du/projet`.
