# Règles communes — SEO/GEO Squad V3
...
3. schémas V3 dans `skill/seo-geo-v3/assets/kit/schemas/` ;
4. `skill/seo-geo-v3/SKILL.md` et ses références V3 ;
...
Toutes les sorties et métadonnées exposées restent sous l'identité générique
`SEO/GEO Audit` ou sous l'identité client explicitement approuvée. Ne jamais
révéler une marque, un domaine, un handle ou un chemin propre à la source
vendored. Une identité absente reste générique ; elle n'est jamais inventée.
...
Références : `skill/seo-geo-v3/references/architecture.md`, `skill/seo-geo-v3/references/workflows/01_intake_digital_twin.md` et `skill/seo-geo-v3/references/product/security_governance.md`.
...
Référence : `skill/seo-geo-v3/references/data_model.md`.
...
Références : `skill/seo-geo-v3/references/scoring_v3.md` et `skill/seo-geo-v3/references/workflows/07_geo_observatory.md`.

## 12. QA et livraison

Avant livraison, exécuter depuis `skill/seo-geo-v3/`, avec exactement la même coupure :
...
Le livrable client n'est produit par aucun script. **L'Agent 11 compose lui-même le HTML** des deux documents en suivant `templates/Charte_PDF_SEO_GEO_V3.md`, puis ce HTML est imprimé en PDF A4 balisé :
