...
- `skill/roso-seo-geo-v3/scripts/validate_project.py` ;
- `skill/roso-seo-geo-v3/scripts/qa_audit.py` ;
- `skill/roso-seo-geo-v3/scripts/score_v3.py` ;
- `skill/roso-seo-geo-v3/scripts/record_delivery.py`.
