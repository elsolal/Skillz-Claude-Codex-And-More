...
- `skill/roso-seo-geo-v3/references/workflows/07_geo_observatory.md` si le GEO est inclus ;
- schémas `evidence`, `facts`, `findings`, `actions`, `geo_run` et `events` dans `skill/roso-seo-geo-v3/assets/kit/schemas/`.
