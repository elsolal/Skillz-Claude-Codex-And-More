...
## Un exemple de référence pour juger tes rapports

Le dossier `exemple_livrable/` contient une paire de PDF de démonstration, sur un cas fictif. Si un rapport te semble en dessous, tu peux simplement demander : **« Régénère au niveau de l'exemple du dossier exemple_livrable/ »**.
