...
| Bing Webmaster Tools — AI Performance | Citations, URLs citées, activité et requêtes de grounding selon disponibilité | **Public Preview** | Lecture | Export manuel ou panel RosoAI qualifié de test. |
...
| Collecteur léger RosoAI | Échantillon HTTP/HTML brut, robots, canonicals, langue, comptage JSON-LD et liens | Contrôlé par RosoAI | Domaine et limites autorisés | Ne rend pas JavaScript ; compléter avec un outil spécialisé lorsque nécessaire. |
