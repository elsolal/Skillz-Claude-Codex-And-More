...
Référence opérationnelle de RosoAI SEO/GEO V3, datée du **15 juillet 2026**. Ce document ne remplace ni un conseil juridique, ni l’analyse du DPO ou du responsable sécurité du client.
...
| Consultant RosoAI | Lecture sur périmètre | Collecter, analyser, produire les recommandations et documenter les limites. |
...
Le client doit pouvoir demander export, rectification ou suppression conformément au rôle juridique défini. Ajouter un accord de sous-traitance lorsque RosoAI traite des données personnelles pour son compte.
