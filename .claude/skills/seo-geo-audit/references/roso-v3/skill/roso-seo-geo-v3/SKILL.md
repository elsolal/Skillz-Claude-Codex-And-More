...
Le livrable client est **écrit par l'Agent 11**, pas généré par un script : lire `templates/Charte_PDF_RosoAI_V3.md` et `core/agents/11_Master_Final_Report_V3.md`. `render_html_pdf.cjs` imprime le HTML tel quel et refuse tout document non conforme à la charte.
