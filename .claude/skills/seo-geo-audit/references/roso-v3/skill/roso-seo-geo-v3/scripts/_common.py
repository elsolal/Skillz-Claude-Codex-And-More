#!/usr/bin/env python3
"""Shared, dependency-light helpers for the RosoAI V3 deterministic scripts."""
...
def find_kit_root(explicit: str | Path | None = None) -> Path:
    ...
    if os.environ.get("ROSO_V3_ROOT"):
        candidates.append(Path(os.environ["ROSO_V3_ROOT"]).expanduser().resolve())
    ...
    raise FileNotFoundError("Racine du kit introuvable. Utilisez --kit-root ou ROSO_V3_ROOT.")
