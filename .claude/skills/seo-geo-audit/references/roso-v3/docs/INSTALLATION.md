# Installation du kit RosoAI SEO/GEO V3 - Édition client
...
```text
/chemin/vers/le/dossier/skills/roso-seo-geo-squad-v3
```
...
Ce moteur imprime le HTML tel quel, en A4 balisé, et refuse tout document non conforme à `templates/Charte_PDF_RosoAI_V3.md`.
...
```bash
python3 skill/roso-seo-geo-v3/scripts/create_project.py /chemin/autorise/client-test \
  --client-name "Client test" --domain "https://example.com"

python3 skill/roso-seo-geo-v3/scripts/validate_project.py /chemin/autorise/client-test
```
