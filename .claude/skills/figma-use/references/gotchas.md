...
// Don't confuse: {r, g, b} for paint colors vs {r, g, b, a} for variable values
```
...
// HUG was reset to FIXED by resize(), frame is now permanently 280x1
...
// E.g., instead of 1 collection with 20 modes (variant x color):
