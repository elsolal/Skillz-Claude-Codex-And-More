...
| **Quality squads** | `/design-audit(-squad)` — 12-agent Lyse Design Squad ; `/seo-geo-audit(-squad)` — RosoAI SEO/GEO V3.1 with 21 routed specialists. |
...
| | `/seo-geo-squad <target>` | RosoAI V3.1 orchestration with 21 routed specialists |
...
| Skill | Role | Key Features |
|---|---|---|
| `seo-geo-audit` | SEO/GEO audit | RosoAI V3.1, 21 routed specialists, structured evidence, separate F/V/O/E/M scores, adversarial QA, Delta and supervised implementation |
