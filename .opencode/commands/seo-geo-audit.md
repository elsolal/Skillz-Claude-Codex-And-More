---
description: SEO/GEO V3.1 audit, GEO, Delta et suivi
---

LOAD the FULL `.opencode/skills/seo-geo-audit/SKILL.md` if it exists, otherwise `.claude/skills/seo-geo-audit/SKILL.md`, READ it completely, and route the provided target through the smallest SEO/GEO V3 workflow that answers the request.
