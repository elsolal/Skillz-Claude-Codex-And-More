---
description: RosoAI SEO/GEO Squad V3.1, 21 spécialistes routés
---

LOAD the FULL `.opencode/skills/seo-geo-audit/SKILL.md` if it exists, otherwise `.claude/skills/seo-geo-audit/SKILL.md`, READ it completely, then run its `--squad` route for the provided target.
