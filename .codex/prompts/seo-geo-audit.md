---
description: 'RosoAI SEO/GEO V3.1: audit express/complet/page, technique, contenu, GEO, Delta et suivi'
disable-model-invocation: true
---

LOAD the FULL `~/.codex/skills/seo-geo-audit/SKILL.md` if it exists, otherwise `.claude/skills/seo-geo-audit/SKILL.md`, READ it completely, and route the provided target through the smallest RosoAI V3 workflow that answers the request.
